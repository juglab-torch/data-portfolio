...
class PortfolioEntry():
    ...
    def download(self, path: Union[str, Path], check_md5 = True, create_parents: bool = True) -> dict:
        ...
        if check_md5:
            ...
            if hash != self.md5_hash:
                raise ValueError(f"MD5 hash of {zip_path} is not correct. Expected {self.md5_hash}, got {hash}.")
